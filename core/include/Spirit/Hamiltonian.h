...
DLLEXPORT void Hamiltonian_Set_BQE(State *state, float bqe, int idx_image=-1, int idx_chain=-1);
DLLEXPORT void Hamiltonian_Set_FSC(State *state, float fsc, int idx_image=-1, int idx_chain=-1);
DLLEXPORT void Hamiltonian_Set_DDI_Radius(State *state, float r_dd, int idx_image=-1, int idx_chain=-1);
...
DLLEXPORT float Hamiltonian_Get_BQE(State *state, int idx_image=-1, int idx_chain=-1);
DLLEXPORT float Hamiltonian_Get_FSC(State *state, int idx_image=-1, int idx_chain=-1);
DLLEXPORT float Hamiltonian_Get_DDI_Radius(State *state, int idx_image=-1, int idx_chain=-1);
